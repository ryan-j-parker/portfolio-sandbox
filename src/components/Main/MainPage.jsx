...
export default function MainPage() {
  return (
    <div className="mainPage">
      <ParallaxProvider>
        <Parallax speed={-5} translateY={[400, -200]}>
        ...
        <Parallax speed={-2} translateY={[800, -100]}>
          <div className="page" id="p2">
            ...
            <p className="projDesc">
              An open-source collaborative music platform that allows musicians to remotely create
              and contribute to projects. Built with a team of 4 in a 4-day sprint using vanilla JS,
              Supabase for db, and the Waveform Playlist API.
            </p>
          </div>
        </Parallax>
        <Parallax speed={2} translateY={[20, -80]}>
          <div className="page" id="p3">
            ...
            <p className="projDesc">
              ...
              their escape from a cabin in the woods. A full-stack application that uses a
              PostgreSQL database to store object data, a library of custom ASCII art assets, and
              RESTful routes built with Express and Node. Built with a team of 3 in a 3-day sprint &
              published as an NPM package.
            </p>
          </div>
        </Parallax>
        <Parallax speed={5} translateY={[20, -160]}>
